...
func canClearWith(c *Cell) bool {
	...
	// terminal types do.
	//
	// Reject cells with non-default background colors. While BCE-capable
	// terminals should handle EL/ECH with background colors correctly,
	// some GPU-accelerated terminals (e.g. Alacritty) may render
	// ECH-erased cells with subtle visual artifacts compared to
	// explicitly-written space characters.
